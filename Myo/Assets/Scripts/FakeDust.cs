...
public class FakeDust : MonoBehaviour {
    ...
    public Mesh spawnMesh()
    {
        ...
        this.GetComponent<MeshRenderer>().material = findMatterial(rand);
        switch (rand)
        {
            case 0: return Cube;
            case 1: return Spere;
    ...
    public Material findMatterial(int rand)
    {
        switch (rand)
        {
            case 0: return cubeMat;
            case 1: return sphereMat;
            case 2: return triangleMat;
        }
        return null;
    }
